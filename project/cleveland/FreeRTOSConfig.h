...
/* Some configuration is dependent on the demo being built. */
  ...
  //#define configPRE_SLEEP_PROCESSING vApplicationPreSleepHook
  //#define configPOST_SLEEP_PROCESSING vApplicationPostSleepHook
#endif
...
#define configCPU_CLOCK_HZ						456000000
#define configMAX_PRIORITIES					( 5 )
#define configMINIMAL_STACK_SIZE				( ( unsigned short ) 120 ) //120
