...
void uart_write_string(U8*);
void uart_write_U8_hex(U8);
void uart_write_U16_hex(U16);
void uart_write_U32_hex(U32);
int UartSendTrace(const char *format, ...);
void uart_mux(U8 en);
#define MHal_UART_Init() uart_init()
